...
ogs <- read.table("~/github/sandbox/holos.stitches.no_cf.upset.txt", sep = "\t", header=TRUE)
...
upset(ogs, sets = c("Diptera", "Lepidoptera", "Coleoptera", "Hymenoptera"), keep.order = TRUE, order.by = "freq", sets.bar.color = "#CA6F1E", mb.ratio = c(0.65, 0.35))
